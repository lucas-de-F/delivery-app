...
<details>
  ...
  - Data de entrega para avaliação final do projeto: `25/05/2022 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-014-c-project-delivery-app.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-014-c-project-delivery-app`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-014-c-project-delivery-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-014-c-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  ➡️ Este projeto já vem com as dependências relacionadas ao _linter_ configuradas nos arquivos `package.json` nos seguintes caminhos:
    - `sd-014-c-project-delivery-app/back-end/package.json`
    - `sd-014-c-project-delivery-app/front-end/package.json`
